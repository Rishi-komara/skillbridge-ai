  ...
  useEffect(() => {
    const loadSkillGapData = async () => {
      try {
        ...
        // Fetch supported roles and history
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-[#91a09d] text-[12px] mt-4">
      ...
      {(pageLoading || loading) && (
        <section className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mt-5">
          {[1, 2, 3, 4].map((item) => (
            <div key={item} className="sb-card p-5 min-h-[145px] animate-pulse">
      ...
      {!pageLoading &&
        ...
        analysis && (
          <>
                  ...
                  >
                    ...
                    >
                      <div>
                        ...
                        <p className="text-[13px] text-[#91a09d] mt-1">
                          {item.category}
                        </p>
                      </div>
            ...
            <div className="mt-5 text-[#91a09d] text-[12px] leading-5">
